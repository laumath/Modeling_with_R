...
datos<-readRDS("C:/Users/Laura/Desktop/UCM/Documentacion2/1_MDDepuracion/datosVinoDep.RDS")
...
levels(input$Azucar_tree) = c('1.64-4.59','<1.64','>4.59')
...
```{r}
# Ordenamos niveles
input$Azucar_tree<-factor(input$Azucar_tree, levels = c('<1.64','1.64-4.59','>4.59'))
...
# Clasificación con nivel de referencia *
todo$Azucar_tree <- relevel(todo$Azucar_tree, ref = "1.64-4.59")
#todo$Etiqueta <- relevel(todo$Etiqueta, ref = "MM")
...
# Clasificación con nivel de referencia *
todo$Azucar_tree <- car::recode(todo$Azucar_tree, "c('<1.64','>4.59') = '<1.64|>4.59'")
#todo$Etiqueta <- relevel(todo$Etiqueta, ref = "MM")
...
```{r}
datos2<-readRDS("C:/Users/Laura/Desktop/UCM/Documentacion2/2_Regresion Lineal/todo_cont_Vino.RDS")
