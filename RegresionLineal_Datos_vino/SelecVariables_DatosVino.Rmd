...
datos<-readRDS("C:/Users/Laura/Desktop/UCM/Documentacion2/2_Regresion Lineal/todo_cont_Vino.RDS")
```
...
names(datos)
 formInt<-formulaInteracciones(datos[,c(1:18,33)],19)#en el subconjunto de las vbles. originales, la objetivo está en la columna 17
