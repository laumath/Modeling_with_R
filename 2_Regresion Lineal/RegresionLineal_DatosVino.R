...
datos<-readRDS("F:/Documentos/Master Comercio 2021-22/Online_Material Minería de Datos_Otoño2021/Dia1_MD&Depuracion/datosVinoDep.RDS")
...
#' 
## ----boxplot continua frente a categorica-----------------------------------------------------------------------------
...
#' 
## ----junto niveles de clasificacion-----------------------------------------------------------------------------------
...
#' 
## ----valicaion cruzada, warning=FALSE---------------------------------------------------------------------------------
...
#' 
## ----resumen metricas en train test-----------------------------------------------------------------------------------
